...
Any view backed by the checked-in fixture (no real control dial wired) is an
honest stub, never presented as a live source. The fixture→real swap is Phase 4
